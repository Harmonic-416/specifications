...
flowchart TB
    ...
    subgraph Server["Server (Supabase — see tech-stack.md)"]
        Auth["User auth"]
        API["REST API"]
...
- Where recordings live and how much we compress (Supabase Storage limits; ties to
  N3 in [requirements](../2-scope/requirements.md)).
